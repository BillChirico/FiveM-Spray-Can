...
function DrawLineForWhile(pos)
    CreateThread(function()
        ...
        repeat
            Wait(0)
            i = i + 1
            DrawMarker(2, pos, 0.0, 0.0, 0.0, 0.0, 180.0, 0.0, 0.1, 0.1, 0.1, 255, 128, 0, 50, false, true, 2, nil, nil,
                false)
        until i == 500
    end)
end
...
local function loadDui()
    ...
    DuiObj = CreateDui('https://cdn.discordapp.com/icons/441748984604917790/a_f21f693129be0d278621a86c8c6ebad5.gif', 128,
        128)
